...
Define a safe root-cron workflow that stops a Docker-hosted Project Zomboid server, creates a verified offline backup of its persistent volume, and powers off the Linux host only after success.
